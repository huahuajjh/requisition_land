	...
	<div class="panel-body">
		<form class="row" onsubmit="return false;">
			...
			<div class="col-md-4">
				<div class="form-group">
					<label>上访人姓名</label>
					<input type="text" id="queryName" class="form-control" placeholder="请输入上访人姓名" maxlength="15" />
				</div>
			</div>
			<div class="col-md-4">
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="form-group">
			<label>信访途径</label>
			<div class="form-control" >{{visitsWay}}</div>
		</div>
	</div>
	<div class="col-md-12">
		<div class="form-group">
...
<div class="col-md-6">
	<div class="form-group">
		<label>信访途径</label>
		<input type="text" name="visitsWay" value="{{visitsWay}}" class="form-control" placeholder="请输入信访途径" maxlength="20">
	</div>
</div>
<div class="col-md-6">
