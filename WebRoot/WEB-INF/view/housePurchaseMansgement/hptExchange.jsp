...
<form class="modal fade" id="huanFaModal" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">购房券换发</h4>
      </div>
...
<table>
	...
	<tr>
		<td class="text-right">旧券号：</td>
		<td>{{oldTicketNumber}}</td>
	</tr>
	<tr>
		<td class="text-right">旧券补贴金额（万元）：</td>
		<td>{{oldBonus}}</td>
	</tr>
	<tr>
		<td class="text-right">旧券制券时间：</td>
		<td>{{oldMakeTime}}</td>
	</tr>
	<tr>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" placeholder="请输入领用人姓名" maxlength="15">
        </div>
    </div>
    <div class="col-md-6" style="display:none;">
        <div class="form-group">
...
<tr>
	...
	<td>
		{{#if isCheck}}
			<a href="javascript:;" class="label label-primary" onclick="showHFModal(this);">换券</a>
		{{/if}}
	</td>
</tr>
</script>
