...
<div class="panel">
	...
	<div class="panel-body">
		<div class="table-responsive">
			<table class="table table-striped table-bordered bootstrap-datatable datatable jTable">
				<thead>
					<tr>
						<th><span class="jHead">姓名</span></th>
						<th><span class="jHead">身份证</span></th>
...
<script type="text/javascript" src="assets/pageJs/housePurchaseMansgement/hptExchangeBill.js"></script>