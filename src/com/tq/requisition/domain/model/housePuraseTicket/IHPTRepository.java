...
public interface IHPTRepository extends IRepository<HousePuraseTicket>{
	 ...
	 * 		发放信息集合
	 */
	void provideByFml(List<HPTProviderInfo> list) throws SpecifiedObjectDoesNotExistsException ;
	 ...
	 * 		返回发放台账model
	 */
	PageFormater queryProvideTable(HPTFuzzyQueryModel queryModel,PageModel pageModel);
